...
useHead({
  title: t('annual_reports.title'),
})

const {data} = await useApiFetch<Collection<AnnualReport>>('/public/annual-reports')
</script>
...
<template>
  <div>
    ...
    <UContainer class="my-6 lg:my-24 text-darkest">
      <h1 class="title mb-4 lg:mb-14">{{ $t('annual_reports.title') }}</h1>
